  ...
  const leadership = [
    {
      ...
      image:
        "https://innovationconference.com.ng/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fdh0rc6p1c%2Fimage%2Fupload%2Fv1744308382%2Finnovation%2FDSC_1065_pp4qio.jpg&w=2048&q=75", // Replace with actual
    },
    {
      ...
      image:
        "https://innovationconference.com.ng/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fdh0rc6p1c%2Fimage%2Fupload%2Fw_1000%2Car_1%3A1%2Cc_fill%2Cg_auto%2Ce_art%3Ahokusai%2Fv1744310251%2Finnovation%2Forganizer%2FWhatsApp_Image_2025-04-10_at_09.45.59_0ede9c77_dpr33d.jpg&w=2048&q=75",
    },
    {
      name: "Gift Faleye",
      ...
      image:
        "https://innovationconference.com.ng/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fdh0rc6p1c%2Fimage%2Fupload%2Fw_1000%2Car_1%3A1%2Cc_fill%2Cg_auto%2Ce_art%3Ahokusai%2Fv1744310256%2Finnovation%2Forganizer%2FWhatsApp_Image_2025-04-09_at_12.34.13_3f49fec4_vokupb.jpg&w=2048&q=75",
    },
  ];
      ...
      <div className="container">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-24">
          {leadership.map((member, index) => (
            <div
              key={index}
              className="group bg-white rounded-md overflow-hidden border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-500"
            >
              ...
              <div className="p-8">
                ...
                <p className="text-primary font-bold text-sm mb-4 uppercase">
                  {member.role}
                </p>
        ...
        {/* Departmental Grid */}
        <div className="bg-white rounded-md p-6 md:p-16 border border-gray-100 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
            {departments.map((dept, index) => (
              <div key={index}>
                <h5 className="text-primary font-black text-xs uppercase mb-4 border-b border-blue-50 pb-2">
                  {dept.name}
                </h5>
                <ul className="space-y-3">
                  {dept.leads.map((lead, idx) => (
                    <li
                      key={idx}
                      className="text-gray-800 font-semibold text-sm hover:text-primary cursor-default transition-colors"
                    >
                      {lead}
                    </li>
                  ))}
